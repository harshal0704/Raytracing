...
// Thread-local RNG (each thread gets its own instance)
inline XorShift64& thread_rng() {
    static thread_local XorShift64 rng(987654321ULL);
    return rng;
}
inline double random01() { return thread_rng().random01(); }
